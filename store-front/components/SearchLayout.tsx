...
export default function SearchLayout({children}: {
  ...
  const buildingFilters = {
    id: 'building',
    name: 'Building',
    options: data?.filter((d: any) => d.meta.toLowerCase() === 'building')
      .map((d: any) => {
        return {
          value: d.name,
          label: d.name,
  ...
  const mechanicalFilters = {
    id: 'mechanical',
    name: 'Mechanical',
    options: data?.filter((d: any) => d.meta.toLowerCase() === 'mechanical')
      .map((d: any) => {
        return {
          value: d.name,
          label: d.name,
              ...
              >
                <Dialog.Panel
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    {[buildingFilters, mechanicalFilters].map((section) => (
